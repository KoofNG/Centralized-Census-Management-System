let mainApp = new Vue({
  ...
  methods: {
    popAlert: function() {
      ...
      document.querySelector("#msgAlert").innerHTML =
    ...
    confirmForm: function() {
      ...
      axios
        .post(
          "http://localhost/Centralized-Census-Management-System/api/users/createUser.php",
          FormData
        )
        .then(response => {
  ...
  mounted() {
    axios
      .get(
        "http://localhost/Centralized-Census-Management-System/assets/js/lga.json"
      )
      .then(response => {
          this.fetchState = response.data;
      })
